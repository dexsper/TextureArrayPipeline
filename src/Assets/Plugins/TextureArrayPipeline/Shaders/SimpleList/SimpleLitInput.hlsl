...
inline void InitializeSimpleLitSurfaceData(float2 uv, float arrayIndex, out SurfaceData outSurfaceData)
{
...
{
    InitializeSimpleLitSurfaceData(uv, 0.0, outSurfaceData);
}
