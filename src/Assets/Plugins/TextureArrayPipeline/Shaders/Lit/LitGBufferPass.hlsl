...
FragmentOutput LitGBufferPassFragment(Varyings input)
{
    ...
    float arrayIndex = DecodeArrayIndexFromColor(input.color);

    SurfaceData surfaceData;
    InitializeStandardLitSurfaceData(input.uv, arrayIndex, surfaceData);
    ...
    SETUP_DEBUG_TEXTURE_DATA(inputData, input.uv, _BaseMapArray);
    ...
    half3 color = GlobalIllumination(brdfData, inputData.bakedGI, surfaceData.occlusion, inputData.positionWS,
